...
The raw data is imported from an excel file named `material.xlsx` and can be seen at the end of the report. 

Download the data [here](https://github.com/dvannanda/paktulay-doors/blob/main/data/materials.xlsx?raw=true).
...
With bins, still having unused capacity, <span style="color:#1CA753;">the total number of bars needed are **`r df_with_bins$bar_needed %>% sum(na.rm = T)`**</span>.
